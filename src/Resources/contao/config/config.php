...
// Content element
$GLOBALS['TL_CTE']['contact_profiles']['hofff_contact_profile']                 = ContactProfileElement::class;
$GLOBALS['TL_CTE']['contact_profiles']['hofff_contact_profile_detail']          = ContactProfileDetailElement::class;
$GLOBALS['TL_CTE']['contact_profiles']['hofff_contact_profile_initials_filter'] = ContactProfileInitialsFilterElement::class;

// Frontend module
$GLOBALS['FE_MOD']['contact_profiles']['hofff_contact_profile']                 = ContactProfileModule::class;
$GLOBALS['FE_MOD']['contact_profiles']['hofff_contact_profile_detail']          = ContactProfileDetailModule::class;
$GLOBALS['FE_MOD']['contact_profiles']['hofff_contact_profile_initials_filter'] = ContactProfileInitialsFilterModule::class;
